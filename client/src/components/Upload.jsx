    ...
    return (
        <div className=''>
            ...
            <div className='text-center mb-24 '>
                ...
                accept='image/*' type="file" id='upload2' hidden />
                <label className='inline-flex gap-3 px-8 py-3.5 cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700 rounded-full' htmlFor="upload2">
